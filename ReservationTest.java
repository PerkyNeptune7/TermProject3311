...
public class ReservationTest {
    ...
    public void testConstructorSetsReservationId() {
        ...
        assertEquals("R002", reservation.getReservationId());
    }

    @Test
    public void testConstructorSetsStartTime() {
        Reservation reservation = createReservation();
        assertEquals(LocalDateTime.of(2026, 3, 23, 9, 0), reservation.getStartTime());
    }

    @Test
    public void testConstructorSetsEndTime() {
        Reservation reservation = createReservation();
        assertEquals(LocalDateTime.of(2026, 3, 23, 12, 0), reservation.getEndTime());
    }

    @Test
    public void testConstructorSetsStatus() {
        Reservation reservation = createReservation();
        assertEquals(getNonCancelledStatus(), reservation.getStatus());
    }
