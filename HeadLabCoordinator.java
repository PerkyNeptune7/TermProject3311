public class HeadLabCoordinator extends UserAccounts {
    ...
    private HeadLabCoordinator(String username, String password) {
    ...
    public static HeadLabCoordinator getInstance() {
        if (instance == null) {
            ...
            instance = new HeadLabCoordinator("headcoord@yorku.ca", "MasterAdmin123!");
        }
        return instance;
    }
    ...
    public LabManager autoGenerateLabManager(String username, String password) {
        ...
        return new LabManager(username, password);
    }
}