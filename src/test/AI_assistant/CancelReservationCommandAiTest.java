...
import app.CancelReservationCommand;
...
public class CancelReservationCommandAiTest {
    ...
    void executeDoesNotChangeReservationId() {
        ...
        Assertions.assertEquals("R005", reservation.getReservationId());
    }
    ...
    void executeDoesNotChangeStartTime() {
        ...
        Assertions.assertEquals(start, reservation.getStartTime());
    }
    ...
    void executeDoesNotChangeEndTime() {
        ...
        Assertions.assertEquals(end, reservation.getEndTime());
    }
