...
public class EquipmentAiTest {
    ...
    void constructorSetsDescriptionCorrectly() {
        ...
        assertEquals("Dell laptop", equipment.getDescription());
    }
    ...
    void constructorSetsLocationCorrectly() {
        ...
        assertEquals("Storage Room", equipment.getLocation());
    }
    ...
    void generatedEquipmentIdsAreUnique() {
        ...
        assertNotEquals(equipment1.getEquipmentId(), equipment2.getEquipmentId());
    }
